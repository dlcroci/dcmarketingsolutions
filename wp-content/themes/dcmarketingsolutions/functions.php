...
function dcms_files() {
  ...
  if (strstr($_SERVER['SERVER_NAME'], 'localhost/dcmarketingsolutions')) {
    ...
    wp_enqueue_script('main-dcms-js', get_theme_file_uri('/bundled-assets/scripts.8dd506313d94d11e1822.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.8dd506313d94d11e1822.css'));
  }
