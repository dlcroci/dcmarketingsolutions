...
function dcms_files() {
  ...
  if (strstr($_SERVER['SERVER_NAME'], 'localhost/dcmarketingsolutions')) {
    ...
    wp_enqueue_script('main-dcms-js', get_theme_file_uri('/bundled-assets/scripts.d4d5d51d067c44445cee.js'), NULL, '1.0', true);
    wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.d4d5d51d067c44445cee.css'));
  }
