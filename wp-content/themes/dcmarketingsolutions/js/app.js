...
function ajustarPantallaNosotros1() {if (document.querySelector("main").outerHTML = mainInicial) {ajustarPantallaNosotros2();} 
                                else if (document.querySelector("main").outerHTML = mainServicios) {document.querySelector("main").outerHTML = mainInicial; ajustarPantallaNosotros2();}
};

function ajustarPantallaServicios1() {if (document.querySelector("main").outerHTML = mainInicial) {ajustarPantallaServicios2();} 
                                else if (document.querySelector("main").outerHTML = mainNosotros) {document.querySelector("main").outerHTML = mainInicial; ajustarPantallaServicios2();}
};
...
function ajustarPantallaNosotros2() {
    ...
    mainNosostros = document.querySelector("main").outerHTML;
    valueNosotros = "";
}
...
function ajustarPantallaServicios2() { 
    ...
    mainServicios = document.querySelector("main").outerHTML;
    valueServicios = "";
}
