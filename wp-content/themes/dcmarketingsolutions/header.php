                                ...
                                <div class="navigator">
                                    <nav class="main-navigation" style="color: #185ea6;">
                                        <ul class="">
                                            ...
                                            <li><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions.net/nosotros/') {echo 'class="activo item"';} else {echo 'class="item"';} ?> id="menuNosotros" href="<?php echo site_url('/nosotros') ?>">NOSOTROS</a></li>
                                            <li><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions.net/servicios/') {echo 'class="activo item"';} else {echo 'class="item"';} ?> id="menuServicios" href="<?php echo site_url('/servicios') ?>">SERVICIOS</a></li>
                                            <li><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions.net/blog/') {echo 'class="activo item"';} else {echo 'class="item"';} ?> id="menuBlog" href="<?php echo site_url('/blog') ?>">BLOG</a></li>
                                            <li class="ocultar"><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions.net/politica-privacidad/') {echo 'class="activo item"';} else {echo 'class="item"';} ?> href="<?php echo site_url('/politica-privacidad') ?>">POLÍTICA DE PRIVACIDAD</a></li>
                                            <li><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions.net/contacto/') {echo 'class="activo item"';} else {echo 'class="item"';} ?> href="<?php echo site_url('/contacto') ?>">CONTÁCTANOS</a></li>
                                        </ul>
                                    </nav>
                                </div>
