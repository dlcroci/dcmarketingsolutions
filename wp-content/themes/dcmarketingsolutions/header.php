                                ...
                                <div class="navigator">
                                    <nav class="main-navigation" style="color: #185ea6;">
                                        <ul class="">
                                            ...
                                            <li class="ocultar"><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions/politica-privacidad') {echo 'class="activo item"';} else {echo 'class="item"';} ?> href="<?php echo site_url('/politica-privacidad') ?>">POLÍTICA DE PRIVACIDAD</a></li>
                                            <li><a <?php if (home_url( add_query_arg( array(), $wp->request ) ) == 'https://dcmarketingsolutions/contacto') {echo 'class="activo item"';} else {echo 'class="item"';} ?> href="<?php echo site_url('/contacto') ?>">CONTÁCTANOS</a></li>
                                        </ul>
                                    </nav>
                                </div>
